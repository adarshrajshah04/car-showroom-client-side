...
const CustomCursor = () => {
  ...
  useEffect(() => {
    ...
    const cursorElements =
      document.querySelectorAll("[data-cursor]"); // data-cursor ek attribute ki traha hai 
    ...
    const magneticElements =
      document.querySelectorAll("[data-magnetic]");//data-magnetic ek attribute ki traha hai 
